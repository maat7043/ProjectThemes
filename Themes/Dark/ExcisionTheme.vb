...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        G.FillPath(BUTTONIMAGE, exDraw.RoundRect(ClientRectangle, 4))
        Dim p As New Pen(New SolidBrush(Color.FromArgb(117, 120, 117)))
        G.DrawPath(Pens.Black, exDraw.RoundRect(ClientRectangle, 4))
        Dim Ip As New Pen(Color.FromArgb(45, Color.White))
        G.DrawPath(Ip, exDraw.RoundRect(InnerRect, 4))
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        Select Case State
            Case MouseState.None
                ...
                G.FillPath(BBG, exDraw.RoundRect(ClientRectangle, 4))
...
Public Class ExcisionGroupBox : Inherits ContainerControl
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        G.FillPath(TEXTUREIMAGE2, exDraw.RoundRect(Bottom, 2))
        G.DrawPath(New Pen(New SolidBrush(Color.FromArgb(26, 24, 25))), exDraw.RoundRect(Bottom, 2))
        G.DrawPath(New Pen(New SolidBrush(Color.FromArgb(10, Color.White))), exDraw.RoundRect(BottomInner, 2))
        ...
        G.FillPath(TEXTUREIMAGE, exDraw.RoundRect(Top, 2))
        G.DrawPath(New Pen(New SolidBrush(Color.FromArgb(26, 24, 25))), exDraw.RoundRect(Top, 2))
        G.DrawPath(New Pen(New SolidBrush(Color.FromArgb(10, Color.White))), exDraw.RoundRect(TopInner, 2))
...
Public Class ExcisionPanel : Inherits ContainerControl
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        G.FillPath(New SolidBrush(Color.FromArgb(58, 56, 57)), exDraw.RoundRect(MainRect, 3))
        G.DrawPath(New Pen(New SolidBrush(Color.FromArgb(77, 77, 77))), exDraw.RoundRect(MainRect, 3))
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        '//// Inner Fill
        G.FillPath(TEXTUREIMAGE2, exDraw.RoundRect(New Rectangle(0, 0, Width - 1, Height - 1), 2))
        G.DrawPath(New Pen(New SolidBrush(Color.FromArgb(26, 26, 26))), exDraw.RoundRect(New Rectangle(1, 1, Width - 3, Height - 3), 2))
        ...
        G.FillPath(g1, exDraw.RoundRect(New Rectangle(2, 2, intValue - 5, Height - 5), 2))

        '/// Bar Overlap
        'Dim h1 As New HatchBrush(HatchStyle.DarkUpwardDiagonal, Color.FromArgb(40, Color.White), Color.FromArgb(20, Color.White))
        'G.FillPath(h1, exDraw.RoundRect(New Rectangle(0, 0, intValue - 1, Height - 2), 1))

        '//// Outer Rectangle
        G.DrawPath(New Pen(Color.FromArgb(190, 70, 70, 70)), exDraw.RoundRect(New Rectangle(0, 0, Width - 1, Height - 1), 2))

        '//// Bar Size
        G.DrawPath(New Pen(Color.FromArgb(150, 97, 94, 90)), exDraw.RoundRect(New Rectangle(2, 2, intValue - 5, Height - 5), 2))
