...
MustInherit Class ThemeContainerNS
...
#End Region
    ...
    Protected Overrides Sub OnHandleDestroyed(ByVal e As EventArgs)
        NSThemeShare.RemoveAnimationCallback(AddressOf DoAnimation)
...
#Region " Property Helpers "
    ...
    Private Sub InvalidateTimer()
        ...
        If _IsAnimated Then
            NSThemeShare.AddAnimationCallback(AddressOf DoAnimation)
        Else
            NSThemeShare.RemoveAnimationCallback(AddressOf DoAnimation)
        End If
    End Sub
...
MustInherit Class ThemeControlNS
    Inherits Control
...
#Region " Animation "
    ...
    Public ThemeTimer As New NSPrecisionTimer
