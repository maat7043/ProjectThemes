...
Module nDraw
    ...
    Public Function TiledTextureFromCode(ByVal str As String) As TextureBrush
        Return New TextureBrush(nDraw.ImageFromCode(str), WrapMode.Tile)
    End Function
End Module
        ...
        If Enabled Then
            ...
            Select Case MouseState
                Case MouseState.None
                    ...
                    g.FillPath(MainBody, nDraw.RoundRect(New Rectangle(0, 0, Width - 1, Height - 1), curve))
                    ...
                    g.DrawPath(New Pen(GlossPen), nDraw.RoundRect(New Rectangle(0, 1, Width - 1, Height - 1), curve + 1))
                Case MouseState.Over
                    ...
                    g.DrawPath(New Pen(GlossPen), nDraw.RoundRect(New Rectangle(1, 1, Width - 3, Height - 3), curve))
            ...
            g.DrawPath(New Pen(Color.FromArgb(31, 36, 42)), nDraw.RoundRect(New Rectangle(0, 0, Width - 1, Height - 1), curve))
        Else
        ...
        If Enabled Then
            ...
            Select Case MouseState
                Case MouseState.None
                    ...
                    g.DrawPath(New Pen(GlossPen), nDraw.RoundRect(New Rectangle(0, 1, Width - 1, Height - 2), curve + 1))
                Case MouseState.Over
                ...
                Case MouseState.Down
                    ...
                    g.DrawPath(New Pen(GlossPen), nDraw.RoundRect(New Rectangle(0, 1, Width - 1, Height - 1), curve + 1))
            End Select
            g.DrawPath(New Pen(Color.FromArgb(21, 38, 56)), nDraw.RoundRect(New Rectangle(0, 0, Width - 1, Height - 1), curve))
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        G.FillPath(New SolidBrush(Color.FromArgb(49, 50, 54)), nDraw.RoundRect(New Rectangle(0, 0, Width - 1, Height - 1), Curve))
        ...
        For i As Integer = 0 To 5
            G.DrawPath(New Pen(GradientPen(i)), nDraw.RoundRect(New Rectangle(i + 1, i + 1, Width - ((2 * i) + 3), Height - ((2 * i) + 3)), Curve))
        Next
        ...
        G.DrawPath(New Pen(BorderPen), nDraw.RoundRect(New Rectangle(0, 0, Width - 1, Height - 1), Curve))
        G.DrawPath(New Pen(Color.FromArgb(32, 33, 37)), nDraw.RoundRect(New Rectangle(0, 0, Width - 1, Height - 2), Curve))
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        If Fill > 4 Then
            g.FillPath(New SolidBrush(Color.FromArgb(80, 164, 234)), nDraw.RoundRect(New Rectangle(0, 0, Fill, Height - 2), curve))
            ...
            g.FillPath(Gloss, nDraw.RoundRect(New Rectangle(0, 0, Fill, Height - 2), curve))
            g.FillPath(FillTexture, nDraw.RoundRect(New Rectangle(0, 0, Fill, Height - 2), curve))
            ...
            g.DrawPath(New Pen(FillGradientBorder), nDraw.RoundRect(New Rectangle(1, 1, Fill - 2, Height - 4), curve))
            g.DrawPath(New Pen(Color.FromArgb(1, 44, 76)), nDraw.RoundRect(New Rectangle(0, 0, Fill, Height - 2), curve))
...
Public Class RedemptionTabControl
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        End If
        G.FillPath(New SolidBrush(Color.FromArgb(49, 50, 54)), nDraw.RoundRect(New Rectangle(ItemSize.Height - 1, 0, Width - ItemSize.Height - 1 - 1, Height - 1), Curve))
        Dim GradientPen As Color() = {Color.FromArgb(43, 44, 48), Color.FromArgb(44, 45, 49), Color.FromArgb(45, 46, 50), Color.FromArgb(46, 47, 51), Color.FromArgb(47, 48, 52), Color.FromArgb(48, 49, 53)}
        For i As Integer = 0 To 5
            G.DrawPath(New Pen(GradientPen(i)), nDraw.RoundRect(New Rectangle(ItemSize.Height - 1 + i + 1, i + 1, Width - ItemSize.Height - 1 - ((2 * i) + 3), Height - ((2 * i) + 3)), Curve))
        Next
        Dim BorderPen As New LinearGradientBrush(New Rectangle(0, 0, Width - 1, Height - 1), Color.Transparent, Color.FromArgb(87, 88, 92), 90S)
        G.DrawPath(New Pen(BorderPen), nDraw.RoundRect(New Rectangle(ItemSize.Height - 1, 0, Width - ItemSize.Height - 1 - 1, Height - 1), Curve))
        G.DrawPath(New Pen(Color.FromArgb(32, 33, 37)), nDraw.RoundRect(New Rectangle(ItemSize.Height - 1, 0, Width - ItemSize.Height - 1 - 1, Height - 2), Curve))
        ...
        For i = 0 To TabCount - 1
            If i = SelectedIndex Then
                ...
                G.FillPath(MainBody, nDraw.RoundRect(OuterBorder, Curve))
                Dim GlossPen As New LinearGradientBrush(OuterBorder, Color.FromArgb(119, 124, 130), Color.FromArgb(64, 67, 72), 90S)
                G.DrawPath(New Pen(GlossPen), nDraw.RoundRect(InnerBorder, Curve))
                G.DrawPath(New Pen(Color.FromArgb(31, 36, 42)), nDraw.RoundRect(OuterBorder, Curve))
            End If
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        For i As Integer = 0 To 5
            G.DrawPath(New Pen(GradientPen(i)), nDraw.RoundRect(New Rectangle(i + 1, i + 1, Width - ((2 * i) + 3), Height - ((2 * i) + 3)), Curve))
        Next
        G.SetClip(nDraw.RoundRect(New Rectangle(0, 0, Width - 1, Height - 2), Curve))
        ...
        G.SetClip(nDraw.RoundRect(New Rectangle(Width - 17, 0, 17, Height - 2), Curve))
        G.DrawPath(New Pen(Color.FromArgb(82, 85, 92)), nDraw.RoundRect(New Rectangle(1, 1, Width - 3, Height - 4), Curve))
        G.ResetClip()
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        G.FillPath(BodyGradient, nDraw.RoundRect(New Rectangle(0, 0, Width - 1, Height - 1), Curve))
        ...
        G.DrawPath(New Pen(BorderPen), nDraw.RoundRect(New Rectangle(0, 1, Width - 1, Height - 2), Curve))
        G.DrawPath(New Pen(Color.FromArgb(32, 33, 37)), nDraw.RoundRect(New Rectangle(0, 0, Width - 1, Height - 1), Curve))


        DrawTriangle(Color.FromArgb(22, 23, 28), New Point(Width - 12, 8), New Point(Width - 6, 8), New Point(Width - 9, 5), G)
        DrawTriangle(Color.FromArgb(22, 23, 28), New Point(Width - 12, 14), New Point(Width - 6, 14), New Point(Width - 9, 17), G)
        G.SetClip(nDraw.RoundRect(New Rectangle(Width - 17, 0, 17, Height), Curve))
        ...
        G.DrawPath(New Pen(ButtonPen), nDraw.RoundRect(New Rectangle(1, 1, Width - 3, Height - 3), Curve))
        G.ResetClip()
        G.DrawLine(New Pen(Color.FromArgb(29, 37, 40)), New Point(Width - 17, 0), New Point(Width - 17, Height - 2))
        G.DrawLine(New Pen(Color.FromArgb(85, 92, 98)), New Point(Width - 16, 1), New Point(Width - 16, Height - 3))
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        G.Clear(Color.Transparent)
        G.FillPath(New SolidBrush(Color.FromArgb(49, 50, 54)), nDraw.RoundRect(New Rectangle(0, 0, Height - 1, Height - 1), Curve))
        Dim GradientPen As Color() = {Color.FromArgb(43, 44, 48), Color.FromArgb(44, 45, 49), Color.FromArgb(45, 46, 50), Color.FromArgb(46, 47, 51), Color.FromArgb(47, 48, 52), Color.FromArgb(48, 49, 53)}
        For i As Integer = 0 To 5
            G.DrawPath(New Pen(GradientPen(i)), nDraw.RoundRect(New Rectangle(i + 1, i + 1, Height - ((2 * i) + 3), Height - ((2 * i) + 3)), Curve))
        Next
        ...
        G.DrawPath(New Pen(BorderPen), nDraw.RoundRect(New Rectangle(0, 0, Height - 2, Height - 1), Curve))
        G.DrawPath(New Pen(Color.FromArgb(32, 33, 37)), nDraw.RoundRect(New Rectangle(0, 0, Height - 2, Height - 2), Curve))
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        Next
        Dim BorderPen As New LinearGradientBrush(New Rectangle(0, 0, Width - 1, Height - 1), Color.Transparent, Color.FromArgb(87, 88, 92), 90S)
        G.DrawPath(New Pen(BorderPen), nDraw.RoundRect(New Rectangle(0, 0, Width - 1, Height - 2), Curve))
        G.DrawPath(New Pen(Color.FromArgb(32, 33, 37)), nDraw.RoundRect(New Rectangle(0, 0, Width - 1, Height - 3), Curve))
        ...
        Select Case Checked
            Case False
                ...
                G.FillPath(CheckedBody, nDraw.RoundRect(New Rectangle(0, 0, 30, Height - 3), Curve))
                ...
                G.DrawPath(New Pen(CheckedBorderPen), nDraw.RoundRect(New Rectangle(0, 0, 30, Height - 3), Curve))
                ...
                G.DrawPath(New Pen(CheckedBorderHighlight), nDraw.RoundRect(New Rectangle(1, 1, 28, Height - 5), Curve))
            ...
            Case True
                ...
                G.FillPath(CheckedBody, nDraw.RoundRect(New Rectangle(29, 0, 30, Height - 3), Curve))
                ...
                G.DrawPath(New Pen(CheckedBorderPen), nDraw.RoundRect(New Rectangle(29, 0, 30, Height - 3), Curve))
                ...
                G.DrawPath(New Pen(CheckedBorderHighlight), nDraw.RoundRect(New Rectangle(30, 1, 28, Height - 5), Curve))
                For i As Integer = 0 To 2
...
Public Class RedemptionListBox : Inherits ListBox
    ...
    Protected Overrides Sub OnDrawItem(e As DrawItemEventArgs)
        ...
        G.TextRenderingHint = TextRenderingHint.AntiAlias
        G.SmoothingMode = SmoothingMode.HighQuality
        G.SetClip(nDraw.RoundRect(New Rectangle(0, 0, Width, Height), Curve))
