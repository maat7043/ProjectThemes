...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        G.FillPath(bg0, uDraw.RoundRect(bgr, 10))
        ...
        Select Case State
            Case MouseState.None
                ...
                G.FillPath(bg, uDraw.RoundRect(bgr, 10))
...
Public Class UbuntuTheme : Inherits ContainerControl
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        G.FillPath(lbb, uDraw.RoundRect(Body, 1))
        G.DrawPath(New Pen(New SolidBrush(Color.FromArgb(60, 60, 60))), uDraw.RoundRect(Body, 1))
        ...
        G.FillPath(lgb, uDraw.RoundRect(TopBar, 4))
        'G.FillPath(tophatch, uDraw.RoundRect(TopBar, 4))
        G.DrawPath(Pens.Black, uDraw.RoundRect(TopBar, 3))
        G.DrawPath(Pens.Black, uDraw.RoundRect(FixBottom, 1))
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        Select Case State
            Case MouseState.None
                ...
                G.FillPath(lgb, uDraw.RoundRect(ClientRectangle, 3))
                G.DrawPath(p, uDraw.RoundRect(ClientRectangle, 3))
...
Public Class UbuntuGroupBox : Inherits ContainerControl
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        G.FillPath(bodygrade, uDraw.RoundRect(New Rectangle(0, 12, Width - 1, Height - 15), 1))

        Dim outerBorder As New LinearGradientBrush(ClientRectangle, Color.FromArgb(50, 50, 50), Color.DimGray, 90S)
        G.DrawPath(New Pen(outerBorder), uDraw.RoundRect(New Rectangle(0, 12, Width - 1, Height - 15), 1))

        Dim lbb As New LinearGradientBrush(TopBar, Color.FromArgb(87, 86, 81), Color.FromArgb(60, 59, 55), 90S)
        G.FillPath(lbb, uDraw.RoundRect(TopBar, 1))

        G.DrawPath(New Pen(New SolidBrush(Color.FromArgb(50, 50, 50))), uDraw.RoundRect(TopBar, 2))
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        G.DrawPath(New Pen(Color.FromArgb(255, 207, 188)), uDraw.RoundRect(New Rectangle(1, 1, Width - 3, Height - 3), 1))
        G.DrawPath(New Pen(Color.FromArgb(255, 207, 188)), uDraw.RoundRect(New Rectangle(1, 1, Width - 3, Height - 3), 2))
        G.DrawPath(New Pen(Color.FromArgb(205, 87, 40)), uDraw.RoundRect(New Rectangle(0, 0, Width - 1, Height - 1), 2))
        G.DrawPath(New Pen(Color.FromArgb(205, 87, 40)), uDraw.RoundRect(New Rectangle(0, 0, Width - 1, Height - 1), 3))
